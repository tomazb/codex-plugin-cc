...
- Prefer running proactive, mid-implementation, or large critiques as a Claude background task so they do not block the main session. Reserve foreground for tiny, well-bounded asks or when the user explicitly asks to wait.
